...
class MockAuthRepository: AuthRepositoryProtocol {
    ...
    func authorize() -> AnyPublisher<Authorize, AuthError> {
        let authorize = Authorize(url: URL(string: "appsheme://xxx-callback?code=fefef5f067171f247fb415e38cb0631797b82f4141dcdee66db846c3ade57a03"))
    ...
    func generateAccessToken(authorizedCode: String) -> AnyPublisher<AuthToken, APIError> {
        let authToken = AuthToken(accessToken: "ea5d0a593b2655e9568f144fb1826342292f5c6b7d406fda00577b8d1530d8a5")
